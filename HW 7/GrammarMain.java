...
public class GrammarMain {
    public static void main(String[] args) throws FileNotFoundException {
        System.out.println("Welcome to the CSE 143X Random Sentence Generator!");
        System.out.println();
    ...
    public static String getSymbol(Scanner console, Grammar grammar) {
        ...
        System.out.print("Which non-terminal do you want to generate (Enter to quit)? ");
    ...
    // console.
    public static void generateNonTerminal(Scanner console, Grammar grammar, String nonTerminal) {
